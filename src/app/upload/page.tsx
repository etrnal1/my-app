...
export default function upload(){
    ...
    // 获取选项
    const [filetype,setSel] = useState('');
    // 获取文件状态
    ...
    const handleSubmit= async(e:React.FormEvent<HTMLFormElement>) => {
      ...
      if (selectedFile) {
        formData.append('file', selectedFile) // ✅ 加入真正的文件对象
      }
        ...
        <div className="p-8 max-w-2xl mx-auto bg-white rounded-lg shadow-lg">
            ...
            <div className="space-y-8">
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
                    ...
                    <select 
                        className="w-full p-3 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white"
                        aria-label="选择文件类型" name="type" value={filetype} onChange={(e)=>setSel(e.target.value)}
                    >
